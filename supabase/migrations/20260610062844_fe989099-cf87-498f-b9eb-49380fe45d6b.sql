...
-- Set search_path and recreate the pgmq wrapper functions to harden them
...
-- Revoke EXECUTE from public/anon/authenticated; only service_role should call these
